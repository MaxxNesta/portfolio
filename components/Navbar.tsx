...
export default function Navbar() {
  ...
  return (
    <>
      <header
        data-cursor="media"
        className="fixed top-0 left-0 right-0 z-[200] flex justify-between items-center px-6 sm:px-10 py-3 sm:py-4 bg-bg border-b border-line sm:border-b-0"
      >
        <Link
          href="/"
          className="font-[family-name:var(--font-quicksand)] text-[16px] tracking-widest uppercase text-ink hover:opacity-60 transition-opacity duration-200 cursor-none"
        >
          Ju
        </Link>
